                  ...
                  <div className="flex items-center gap-4">
                    {editingTicketsId === passenger.id ? (
                      <div className="bg-slate-700/50 p-4 rounded-lg space-y-3">
                        <div>
                          <label className="text-xs text-slate-300 block mb-1">Cantidad de tickets</label>
                          <input
                            type="number"
                ...
                {deletingId === passenger.id ? (
                  <div className="mt-4 p-4 bg-red-900/20 border border-red-700 rounded-lg">
                    ...
                    <div className="space-y-3">
                      <div>
                        <label className="text-xs text-slate-300 block mb-1">Monto devolución (opcional)</label>
                        <input
                          type="number"
                      ...
                      {montoDevolucion && (
                        <div>
                          <label className="text-xs text-slate-300 block mb-1">Método devolución</label>
                          <select
